...
class ResNet(nn.Module):
    ...
    def output_num(self):
        return resnet101(True).fc.in_features
...
class ResNet101(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder = resnet101(False)
        self.encoder.load_state_dict(torch.load('/media/ubuntu/7d17c4ae-0255-4946-a82e-1ebcb5295708/zjt/resnet101-5d3b4d8f.pth'))
